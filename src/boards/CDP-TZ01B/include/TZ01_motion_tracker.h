...
/**
 * @brief Initialize Motion tracker library.
 *
 ...
 * @param[out] x  Computed value of X-axis/Pitch.(UINT: degree/s)
 * @param[out] y  Computed value of Y-axis/Roll. (UINT: degree/s)
 * @param[out] z  Computed value of Z-axis/Yaw.  (UINT: degree/s)
 * @return Read result.
 * @retval true : Success.
 ...
 * @param[out] x  Computed value of X-axis.(UINT: G)
 * @param[out] y  Computed value of Y-axis.(UINT: G)
 * @param[out] z  Computed value of Z-axis.(UINT: G)
 * @return Read result.
 * @retval true : Success.
 * @retval false: Failed.(Ex. Driver state missmatch.)
 */
 ...
 * @param[out] t  Computed value.(degree Celsius)
 * @return Read result.
 * @retval true : Success.
 * @retval false: Failed.(Ex. Driver state missmatch.)
 */
 ...
 * @param[out] ry Raw value of Y-axis.
 * @param[out] rz Raw value of Z-axis.
 * @param[out] x  Computed value of X-axis.(UINT: uH)
 * @param[out] y  Computed value of Y-axis.(UINT: uH)
 * @param[out] z  Computed value of Z-axis.(UINT: uH)
 * @return Read result.
 * @retval true : Success.
 * @retval false: Failed.(Ex. Driver state missmatch.)
 */
 ...
 *
 * @param[out] pitch_rad (UNIT: radian)
 * @param[out] roll_rad  (UNIT: radian)
 * @return Read result.
 * @retval true : Success.
 * @retval false: Failed.(Ex. Driver state missmatch.)
 */
 ...
 *
 * @param[in]  acc_x X-axis accel value(G)
 * @param[in]  acc_y Y-axis accel value(G)
 * @param[in]  acc_z Z-axis accel value(G)
 * @param[out] pitch_rad Computed pitch (UNIT: radian)
 * @param[out] roll_rad  Computed roll  (UNIT: radian)
 */
