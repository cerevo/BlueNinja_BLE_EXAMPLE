...
extern void twicUtAncsSetupNc(void);
extern void twicUtAncsStopNc(void);
extern void twicUtAncsStartNc(void);
extern void twicUtAncsRunNc(twicConnIface_t * const cif);
extern void twicUtAncsNcNotificationReceived(const void * const cif,
