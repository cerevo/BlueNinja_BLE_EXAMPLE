...
#define TZ1SM_HAL_HI_SLEEP0_TO_ACTIVE_US (84)
#define TZ1SM_HAL_HI_SLEEP1_TO_ACTIVE_US (82)
#define TZ1SM_HAL_HI_SLEEP2_TO_ACTIVE_US (82)
#define TZ1SM_HAL_HI_WAIT_TO_ACTIVE_US (2180)
#define TZ1SM_HAL_HI_WAIT_RETENTION_TO_ACTIVE_US (2180)
#define TZ1SM_HAL_HI_RETENTION_TO_ACTIVE_US (2210)
#define TZ1SM_HAL_HI_RTC_TO_ACTIVE_US (37100)
#define TZ1SM_HAL_HI_STOP_TO_ACTIVE_US (60000) /* 1044000 */

#define TZ1SM_HAL_UM_SLEEP0_TO_ACTIVE_US (93)
#define TZ1SM_HAL_UM_SLEEP1_TO_ACTIVE_US (91)
#define TZ1SM_HAL_UM_SLEEP2_TO_ACTIVE_US (91)
#define TZ1SM_HAL_UM_WAIT_TO_ACTIVE_US (2180)
#define TZ1SM_HAL_UM_WAIT_RETENTION_TO_ACTIVE_US (2180)
#define TZ1SM_HAL_UM_RETENTION_TO_ACTIVE_US (2210)
#define TZ1SM_HAL_UM_RTC_TO_ACTIVE_US (37100)
#define TZ1SM_HAL_UM_STOP_TO_ACTIVE_US (60000) /* 1044000 + 2260 */

#define TZ1SM_HAL_LM_SLEEP0_TO_ACTIVE_US (163)
#define TZ1SM_HAL_LM_SLEEP1_TO_ACTIVE_US (160)
#define TZ1SM_HAL_LM_SLEEP2_TO_ACTIVE_US (174)
#define TZ1SM_HAL_LM_WAIT_TO_ACTIVE_US (1505)
#define TZ1SM_HAL_LM_WAIT_RETENTION_TO_ACTIVE_US (1505)
#define TZ1SM_HAL_LM_RETENTION_TO_ACTIVE_US (1540)
#define TZ1SM_HAL_LM_RTC_TO_ACTIVE_US (37100)
#define TZ1SM_HAL_LM_STOP_TO_ACTIVE_US (60000) /* 1044000 + 1520 */

#define TZ1SM_HAL_LO_SLEEP0_TO_ACTIVE_US (341)
#define TZ1SM_HAL_LO_SLEEP1_TO_ACTIVE_US (338)
#define TZ1SM_HAL_LO_SLEEP2_TO_ACTIVE_US (373)
#define TZ1SM_HAL_LO_WAIT_TO_ACTIVE_US (398)
#define TZ1SM_HAL_LO_WAIT_RETENTION_TO_ACTIVE_US (404)
#define TZ1SM_HAL_LO_RETENTION_TO_ACTIVE_US (427)
#define TZ1SM_HAL_LO_RTC_TO_ACTIVE_US (37100)
#define TZ1SM_HAL_LO_STOP_TO_ACTIVE_US (60000) /* 1044000 + 360 */

#define TZ1SM_HAL_VF_LAG_HI_TO_UM_US (2260)
#define TZ1SM_HAL_VF_LAG_HI_TO_LM_US (1520)
#define TZ1SM_HAL_VF_LAG_HI_TO_LO_US (360)

#define TZ1SM_HAL_VF_LAG_UM_TO_HI_US (2260)
#define TZ1SM_HAL_VF_LAG_UM_TO_LM_US (1520)
#define TZ1SM_HAL_VF_LAG_UM_TO_LO_US (360)

#define TZ1SM_HAL_VF_LAG_LM_TO_HI_US (2210)
#define TZ1SM_HAL_VF_LAG_LM_TO_UM_US (2210)
#define TZ1SM_HAL_VF_LAG_LM_TO_LO_US (310)

#define TZ1SM_HAL_VF_LAG_LO_TO_HI_US (2210)
#define TZ1SM_HAL_VF_LAG_LO_TO_UM_US (2210)
#define TZ1SM_HAL_VF_LAG_LO_TO_LM_US (1500)
