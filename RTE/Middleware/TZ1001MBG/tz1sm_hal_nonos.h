...
#ifndef _TZ1SM_HAL_NONOS_H_
#define _TZ1SM_HAL_NONOS_H_
...
/* hz is not SystemCoreClock. */
void tz1smHalTimerFakeAlarmTrigger(uint32_t hz);

typedef uint32_t tz1smHalMutexId_t;
